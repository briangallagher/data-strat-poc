...
export const selectable = (label, { rowIndex, columnIndex, rowData, column, property, tooltip }) => {
    ...
    return {
        ...
        children: (_jsx(SelectColumn, Object.assign({}, customProps, { selectVariant: selectVariant, onSelect: selectClick, name: selectName, tooltip: tooltip, isIndeterminate: rowId === -1 ? isIndeterminate : undefined, children: label })))
    };
};
