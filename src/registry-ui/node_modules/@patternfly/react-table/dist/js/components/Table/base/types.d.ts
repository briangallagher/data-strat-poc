...
export declare const TableDefaults: {
    renderers: {
        table: import("react").ForwardRefExoticComponent<Omit<import("../Table").TableProps, "ref"> & import("react").RefAttributes<HTMLTableElement>>;
        header: {
            wrapper: import("react").ForwardRefExoticComponent<Omit<import("../Thead").TheadProps, "ref"> & import("react").RefAttributes<HTMLTableSectionElement>>;
            row: import("react").ForwardRefExoticComponent<Omit<import("../Tr").TrProps, "ref"> & import("react").RefAttributes<HTMLTableRowElement>>;
            cell: import("react").ForwardRefExoticComponent<Omit<import("../Th").ThProps, "ref"> & import("react").RefAttributes<HTMLTableHeaderCellElement>>;
        };
        body: {
            wrapper: import("react").ForwardRefExoticComponent<Omit<import("../Tbody").TbodyProps, "ref"> & import("react").RefAttributes<HTMLTableSectionElement>>;
            row: import("react").ForwardRefExoticComponent<Omit<import("../Tr").TrProps, "ref"> & import("react").RefAttributes<HTMLTableRowElement>>;
            cell: import("react").ForwardRefExoticComponent<Omit<import("../Td").TdProps, "ref"> & import("react").RefAttributes<HTMLTableDataCellElement>>;
        };
    };
};
