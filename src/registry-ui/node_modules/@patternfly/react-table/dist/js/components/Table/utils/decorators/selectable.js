...
const selectable = (label, { rowIndex, columnIndex, rowData, column, property, tooltip }) => {
    ...
    return {
        ...
        children: ((0, jsx_runtime_1.jsx)(SelectColumn_1.SelectColumn, Object.assign({}, customProps, { selectVariant: selectVariant, onSelect: selectClick, name: selectName, tooltip: tooltip, isIndeterminate: rowId === -1 ? isIndeterminate : undefined, children: label })))
    };
};
