...
class TimePicker extends react_1.Component {
    constructor(props) {
        super(props);
        this.baseComponentRef = (0, react_1.createRef)();
        this.toggleRef = (0, react_1.createRef)();
        this.inputRef = (0, react_1.createRef)();
        this.menuRef = (0, react_1.createRef)();
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsx)(helpers_1.GenerateId, { prefix: "time-picker-", children: (generatedId) => {
                ...
                const menuContainer = ((0, jsx_runtime_1.jsx)(Menu_1.Menu, { ref: this.menuRef, isScrollable: true, children: (0, jsx_runtime_1.jsx)(Menu_1.MenuContent, { maxMenuHeight: "200px", children: (0, jsx_runtime_1.jsx)(Menu_1.MenuList, { "aria-label": ariaLabel, children: options.map((option, index) => ((0, jsx_runtime_1.jsx)(Menu_1.MenuItem, { onClick: this.onSelect, id: `${randomId}-option-${index}`, children: option }, option))) }) }) }));
                const textInput = ((0, jsx_runtime_1.jsx)(TextInput_1.TextInput, Object.assign({ "aria-haspopup": "menu", id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", customIcon: (0, jsx_runtime_1.jsx)(outlined_clock_icon_1.default, {}), onClick: this.onInputClick, onChange: this.onInputChange, autoComplete: "off", isDisabled: isDisabled, isExpanded: isTimeOptionsOpen, ref: this.inputRef }, inputProps)));
                ...
                return ((0, jsx_runtime_1.jsx)("div", { ref: this.baseComponentRef, className: (0, react_styles_1.css)(date_picker_1.default.datePicker, className), children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: (0, react_styles_1.css)(date_picker_1.default.datePickerInput), style: style }, props, { children: [(0, jsx_runtime_1.jsx)(InputGroup_1.InputGroup, { children: (0, jsx_runtime_1.jsx)(InputGroup_1.InputGroupItem, { children: (0, jsx_runtime_1.jsx)("div", { id: randomId, children: (0, jsx_runtime_1.jsx)("div", { ref: this.toggleRef, style: { paddingLeft: '0' }, children: (0, jsx_runtime_1.jsx)(Popper_1.Popper, { appendTo: calculatedAppendTo, trigger: textInput, triggerRef: this.toggleRef, popper: menuContainer, popperRef: this.menuRef, isVisible: isTimeOptionsOpen, zIndex: zIndex }) }) }) }) }), isInvalid && ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(date_picker_1.default.datePickerHelperText), children: (0, jsx_runtime_1.jsx)(HelperText_1.HelperText, { children: (0, jsx_runtime_1.jsx)(HelperText_1.HelperTextItem, { variant: "error", children: !isValidFormat ? invalidFormatErrorMessage : invalidMinMaxErrorMessage }) }) }))] })) }));
            } }));
    }
}
