...
const MultipleFileUploadStatus = (_a) => {
    ...
    const expandableSectionId = (0, helpers_1.useSSRSafeId)('pf-expandable-section-');
    ...
    (0, react_1.useEffect)(() => {
        switch (statusToggleIcon) {
            case 'danger':
                ...
                break;
            case 'success':
                setIcon((0, jsx_runtime_1.jsx)(rh_ui_check_circle_fill_icon_1.default, {}));
                break;
            case 'inProgress':
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(multiple_file_upload_1.default.multipleFileUploadStatus, className) }, props, { children: (0, jsx_runtime_1.jsx)(ExpandableSection_1.ExpandableSection, { contentId: `${expandableSectionId}-content`, toggleId: `${expandableSectionId}-toggle`, toggleContent: toggle, isExpanded: isOpen, onToggle: toggleExpandableSection, children: (0, jsx_runtime_1.jsx)("ul", { className: `${multiple_file_upload_1.default.multipleFileUploadStatus}-list`, role: "list", "aria-label": ariaLabel, children: children }) }) })));
};
