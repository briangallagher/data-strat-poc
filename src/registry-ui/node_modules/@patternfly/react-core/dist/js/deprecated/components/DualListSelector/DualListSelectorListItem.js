...
const DualListSelectorListItemBase = (_a) => {
    var { onOptionSelect, orderIndex, children, className, id: idProp, isSelected, innerRef, isDraggable = false, isDisabled, 
    ...
    const generatedId = (0, helpers_1.useSSRSafeId)('dual-list-selector-list-item-');
